...
const Menu = ({ openMenu, setOpenMenu }) => {
  ...
  return (
    <aside
      id="logo-sidebar"
      aria-label="Sidebar"
      className={` sm:border-r bg-gray-50 sm:border-gray-200 sm:sticky sm:top-0 sm:pt-20 sm:left-0 sm:w-48 lg:w-72 sm:h-screen sm:transition-transform sm:translate-x-0`}
    >
